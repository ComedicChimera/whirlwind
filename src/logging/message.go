...
// InternalError is an error that is generated by the compiler to represent some
// fault within the compiler itself -- such as the grammar failing to initialize
// or a misconstructed module. These errors are not fatal: normally, they
// represent an issue with configuration.
type InternalError struct {
	Kind    string
	Message string
}

func (ie *InternalError) isError() bool {
	return true
}
